...
func spawn_pipe() -> void:
	...
	var y_position = randf_range(upper_spawn.global_position.y, lower_spawn.global_position.y)
	new_pipes.global_position = Vector2(upper_spawn.global_position.x, y_position)
